...
import org.reactome.server.tools.pdf.exporter.playground.exceptions.FailToGetFireworksException;
...
public class FireworksExporterFactory {
    ...
    public static BufferedImage getFireworks(String token) throws FailToGetFireworksException {
        try {
            ...
            throw new FailToGetFireworksException("Fail to get fireworks for token:" + token, pascual);
        }
    }
}
